...
WORD ENGINE (`/api/claude`, `mode: association`) uses **Anthropic only** (no Datamuse). It asks the model for up to **100** association words per submit, using the Universal Association Engine spec loaded from the repo.
