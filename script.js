    ...
    div.innerHTML = `
        ...
        <div class="position-cons-form">
            <div class="position-cons-main-layout">
                <div class="position-cons-inputs">
                    <div class="position-cons-small-inputs">
                        <div class="position-cons-small-input">
                    ...
                    <div class="position-cons-letters-section">
                ...
                <div class="position-cons-buttons">
